...
const HomePage = () => {
  ...
  const handleShortenUrl = async (e: React.FormEvent) => {
    ...
    // setTimeout(() => {
    //   const shortened = `tiny.link/${Math.random().toString(36).substring(7)}`
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-blue-900 via-teal-900 to-blue-900 flex items-center justify-center p-4">
        ...
        <form onSubmit={handleShortenUrl} className="space-y-6">
          ...
          {shortUrl && (
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors flex items-center justify-center gap-2 text-sm font-medium"
              >
          ...
          {!shortUrl && (
            <button
              ...
              className="w-full px-4 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors font-medium text-sm"
            >
